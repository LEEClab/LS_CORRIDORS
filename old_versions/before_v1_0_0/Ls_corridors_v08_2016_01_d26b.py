          ...
          while (len(Form1.patch_id_list)>1):
            ...
            for i in range(Form1.Nsimulations):
                if Form1.listafinal[cont]==Form1.OutArqCost:       
                  Form1.mapa_corredores_sem0=Form1.NEXPER_FINAL+'_'+'S_'+Form1.S1FORMAT+"_T_"+Form1.T1FORMAT+"_M1"   
                if Form1.listafinal[cont]=='M2_MODE':
                  Form1.mapa_corredores_sem0=Form1.NEXPER_FINAL+'_'+'S_'+Form1.S1FORMAT+"_T_"+Form1.T1FORMAT+"_M2"  
                if Form1.listafinal[cont]=='M3_MAXIMUM':
                  Form1.mapa_corredores_sem0=Form1.NEXPER_FINAL+'_'+'S_'+Form1.S1FORMAT+"_T_"+Form1.T1FORMAT+"_M3"                
                if Form1.listafinal[cont]=='M4_AVERAGE':
                  Form1.mapa_corredores_sem0=Form1.NEXPER_FINAL+'_'+'S_'+Form1.S1FORMAT+"_T_"+Form1.T1FORMAT+"_M4"                  
