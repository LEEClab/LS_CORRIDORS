    ...
    def OnClick(self,event):
        ...
        if event.GetId()==10:   #10==START
          ...
          if Form1.Nsimulations2>0:
            ...
            grass.run_command('r.neighbors',input=Form1.OutArqCost,output=Form1.C2, method='mode',size=Form1.escfina1,overwrite = True)
            
          if Form1.Nsimulations3>0:
            Form1.defaultsize_moviwin_allcor=Form1.escfina1
            grass.run_command('r.neighbors',input=Form1.OutArqCost,output=Form1.C3, method='average',size=Form1.escfina1,overwrite = True)
          
          if Form1.Nsimulations4>0:
            Form1.defaultsize_moviwin_allcor=Form1.escfina1
            grass.run_command('r.neighbors',input=Form1.OutArqCost,output=Form1.C4, method='maximum',size=Form1.escfina1,overwrite = True)
          ...
          while (len(Form1.patch_id_list)>1):
            ...
            while Form1.ChecktTry==True:
              try:
                ...
                Form1.listErrorLog.append("[Error ->-> :] < - Create source raster file : "+Form1.ARQSAIDA+" - > ---"+`Form1.year_now`+"-"+ `Form1.month_now` + "-"+ `Form1.day_now`+" --- time : "+`Form1.hour_now `+":"+`Form1.second_now`)
            ...
            while Form1.ChecktTry==True:
              try:
                ...
                Form1.minuts_now=Form1.time.minute #GET START Form1.minuts
                Form1.second_now=Form1.time.second #GET START                  
                Form1.listErrorLog.append("[Error ->-> :] < - Create target raster file : "+Form1.ARQSAIDA+" - > ---"+`Form1.year_now`+"-"+ `Form1.month_now` + "-"+ `Form1.day_now`+" --- time : "+`Form1.hour_now `+":"+`Form1.second_now`)
