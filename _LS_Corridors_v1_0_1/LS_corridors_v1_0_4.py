...
class Corridors(wx.Panel):
    def __init__(self, parent, id):
        ...
        self.button =wx.Button(self, 230, "SELECT FILE", wx.Point(100,115)) #cost
...
class Corridors(wx.Panel):
    def __init__(self, parent, id):
        ...
        self.button =wx.Button(self, 210, "SELEC FILE", wx.Point(280,115))#st
        wx.EVT_BUTTON(self, 210, self.OnClick)
        
        self.button =wx.Button(self, 230, "SELEC FILE", wx.Point(100,115)) #cost
        wx.EVT_BUTTON(self, 230, self.OnClick)
        ...
        self.lblname = wx.StaticText(self, -1, "Resistance Map:", wx.Point(20,118))
        self.lblname2 = wx.StaticText(self, -1, "Target Map:", wx.Point(183,120))
